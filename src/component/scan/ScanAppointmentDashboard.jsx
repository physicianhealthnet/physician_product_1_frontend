        ...
        <StaggerItem>
          <div className="flex flex-col gap-4 mt-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <PipelineBucket title="Missing" count={metrics.missing} description="Patients who did not show up for scans." icon="solar:user-cross-linear" color="bg-red-500" />
              <PipelineBucket title="Report Not Ready" count={metrics.reportNotReady} description="Scans completed but pending final report." icon="solar:document-text-linear" color="bg-purple-500" />
