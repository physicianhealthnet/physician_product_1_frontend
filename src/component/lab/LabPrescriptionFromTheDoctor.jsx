...
function LabPrescriptionFromTheDoctor() {
  ...
  const handleScheduleSubmit = async () => {
    ...
    try {
      ...
      await AxiosInstance.put(`/lab-prescription/${selectedRowForSchedule}/status`, { 
        status: "REPORT UPLOAD",
        appointmentDateTime 
      });
      message.success("Lab test scheduled successfully!");
  ...
  const handleUploadSubmit = async () => {
    ...
    formData.append("labReportFile", uploadFile);
    
    try {
      await AxiosInstance.put(`/lab-prescription/${selectedRowForUpload}`, formData, {
        headers: { "Content-Type": "multipart/form-data" }
      });
      await AxiosInstance.put(`/lab-prescription/${selectedRowForUpload}/status`, { status: "COMPLETED" });
      message.success("Report uploaded and lab completed successfully!");
  ...
  return (
    <div className="p-4 md:p-8 flex flex-col gap-6 max-w-7xl mx-auto">
      ...
      >
        <div className="flex flex-col gap-4 py-4">
          <p className="text-sm text-slate-500 m-0">
            Select a date and time to schedule this lab test. It will automatically move to the <strong>Report Upload</strong> tab so you can upload the results after the appointment.
          </p>
          <div className="flex flex-col gap-2">
      ...
      >
        <div className="flex flex-col gap-4 py-4">
          <p className="text-sm text-slate-500 m-0">
            Please attach the lab report document (PDF, JPG, PNG). 
...
export default LabPrescriptionFromTheDoctor;
